...
export default function Home() {
  ...
  return (
    <div className="flex flex-col md:px-12 px-0 relative bg-background font-poppins items-center min-h-screen">
      <h1 className="text-6xl text-active font-bold mt-20">
        Bought <span className="text-primary">Out</span>
      </h1>
      ...
      >
        <input
          type="text"
          className="flex w-full rounded-lg px-5 py-3 text-base text-primary font-semibold focus:outline-none focus:ring-2 focus:ring-active"
        ...
        <div className="mt-5 flex sm:flex-row flex-col justify-start">
          <div className="sm:w-1/3 w-full">
            ...
            <select
              className="mt-1 flex w-full rounded-lg px-5 py-3 text-base text-primary font-bold focus:outline-none"
          ...
          <div className="sm:ml-10 sm:w-1/3 w-full">
            ...
            <input
              type="number"
              className="mt-1 w-full rounded-lg px-5 py-3 text-base text-primary font-bold focus:outline-none"
      ...
      <div className="mt-20 mb-10 text-center">
        <p className="text-primary text-xs">
          ...
          <a
            ...
            href="https://github.com/0xEdwinD"
          >
